...
def test_celula_sem_vizinhos_facil(campo_minado):
    ...
    assert campo_minado.contar_vizinhos(0, 0) == 0
...
def test_celula_com_8_vizinhos_facil(campo_minado):
    ...
    assert campo_minado.contar_vizinhos(4, 4) == 8+1  # Teste se a função retorna 8 para uma célula no centro do tabuleiro cercada por bandeiras.
...
def test_celula_na_borda_sem_vizinhos_facil(campo_minado):
    campo_minado.iniciar_jogo(8, 8, 10)
    assert campo_minado.contar_vizinhos(0, 0) == 0  # Teste se a função retorna 0 para uma célula na borda do tabuleiro que não tem vizinhos com bandeiras.
...
def test_celula_na_borda_com_3_vizinhos_facil(campo_minado):
    ...
    assert campo_minado.contar_vizinhos(0, 3) == 3-1
...
def test_celula_na_esquina_com_2_vizinhos_facil(campo_minado):
    ...
    assert campo_minado.contar_vizinhos(0, 0) == 3-1
