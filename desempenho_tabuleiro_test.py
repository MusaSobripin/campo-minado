...
def test_desempenho_tabuleiro_pequeno_facil(campo_minado):
...
def test_desempenho_tabuleiro_pequeno_intermediario(campo_minado):
...
def test_desempenho_tabuleiro_pequeno_dificil(campo_minado):
